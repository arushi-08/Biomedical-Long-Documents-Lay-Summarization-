...
from transformers import AutoTokenizer, LongT5ForConditionalGeneration, T5Tokenizer, LongT5EncoderModel, pipeline, AutoModelWithLMHead
import tiktoken
...
model = AutoModelWithLMHead.from_pretrained(
    "models/longt5-large-16384-pubmed_lora_finetuned/"
).cuda()
...
def run_long_T5_summarization(model, map_prompt, combine_prompt):
    ...
    tokenizer = AutoTokenizer.from_pretrained("Stancld/longt5-tglobal-large-16384-pubmed-3k_steps")
    long_t5_enc_model = LongT5EncoderModel.from_pretrained("models/longt5-large-16384-pubmed_lora_finetuned/").to("cuda")
    ...
    all_summ = []
    with open("elife_loRa.txt", "w") as f:
